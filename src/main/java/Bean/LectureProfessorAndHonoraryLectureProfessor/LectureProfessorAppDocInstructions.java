...
public class LectureProfessorAppDocInstructions {
    ...
    private List<LectureProfessorAppDocInstructions> lectureProfessorAppDocInstructionsList = new ArrayList<>();


    public LectureProfessorAppDocInstructions(String userNumber, String technologyTransferContractName, String technologyTransferDepartment, String contractDate, String technologyTransferFund, String technologyTransferFundBringInDate) {
    ...
    public LectureProfessorAppDocInstructions() {
    ...
    public List<LectureProfessorAppDocInstructions> getLectureProfessorAppDocInstructionsList() {
        return lectureProfessorAppDocInstructionsList;
    }

    public void setLectureProfessorAppDocInstructionsList(List<LectureProfessorAppDocInstructions> lectureProfessorAppDocInstructionsList) {
        this.lectureProfessorAppDocInstructionsList = lectureProfessorAppDocInstructionsList;
    }
}
