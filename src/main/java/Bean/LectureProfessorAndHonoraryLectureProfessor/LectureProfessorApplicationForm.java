...
public class LectureProfessorApplicationForm {
    ...
    private String name;
    private String job;
    private String serviceSchoolAndDepartment;
    ...
    private Boolean applicationrequirements10;
    private Boolean applicationrequirements11;
    private Boolean applicationrequirements12;
    private Boolean applicationrequirements13;
    private Boolean applicationrequirements14;
    private Boolean applicationrequirements15;
    private Boolean applicationrequirementsCheck;
    private Boolean lectureCategoryExp;
    private Boolean lectureCategoryInv;
    ...
    public LectureProfessorApplicationForm(int project_id, String usernum, String name, String job, String serviceSchoolAndDepartment, String certificatenum, String workStartDate, String seniority, String email, String researchroomext, String cellphone, Boolean applicationrequirements1, Boolean applicationrequirements2, Boolean applicationrequirements3, Boolean applicationrequirements4, Boolean applicationrequirements5, Boolean applicationrequirements6, Boolean applicationrequirements7, Boolean applicationrequirements8, Boolean applicationrequirements9, Boolean applicationrequirements10, Boolean applicationrequirements11, Boolean applicationrequirements12, Boolean applicationrequirements13, Boolean applicationrequirements14, Boolean applicationrequirements15, Boolean applicationrequirementsCheck, Boolean lectureCategoryExp, Boolean lectureCategoryInv, Boolean lectureCategoryLif, String additionalInfo) {
        ...
        this.name = name;
        this.job = job;
        this.serviceSchoolAndDepartment = serviceSchoolAndDepartment;
        ...
        this.lectureCategoryInv = lectureCategoryInv;
    ...
    public String getServiceSchoolAndDepartment() {
        return serviceSchoolAndDepartment;
    }
    ...
    public Boolean getLectureCategoryExp() {
        return lectureCategoryExp;
    }

    public void setLectureCategoryExp(Boolean lectureCategoryExp) {
        this.lectureCategoryExp = lectureCategoryExp;
    }

    public Boolean getLectureCategoryInv() {
        return lectureCategoryInv;
    }

    public void setLectureCategoryInv(Boolean lectureCategoryInv) {
        this.lectureCategoryInv = lectureCategoryInv;
    }

    public Boolean getLectureCategoryLif() {
        return lectureCategoryLif;
    }

    public void setLectureCategoryLif(Boolean lectureCategoryLif) {
        this.lectureCategoryLif = lectureCategoryLif;
    }
    ...
    public Boolean getApplicationrequirements10() {
        return applicationrequirements10;
    }

    public Boolean getApplicationrequirements11() {
        return applicationrequirements11;
    }

    public Boolean getApplicationrequirements12() {
        return applicationrequirements12;
    }

    public Boolean getApplicationrequirements13() {
        return applicationrequirements13;
    }

    public Boolean getApplicationrequirements14() {
        return applicationrequirements14;
    }

    public Boolean getApplicationrequirements15() {
        return applicationrequirements15;
    }

    public Boolean getApplicationrequirementsCheck() {
        return applicationrequirementsCheck;
    }
    ...
    public void setServiceSchoolAndDepartment(String serviceSchoolAndDepartment) {
        this.serviceSchoolAndDepartment = serviceSchoolAndDepartment;
    }
    ...
    public void setApplicationrequirements10(Boolean applicationrequirements10) {
        this.applicationrequirements10 = applicationrequirements10;
    }

    public void setApplicationrequirements11(Boolean applicationrequirements11) {
        this.applicationrequirements11 = applicationrequirements11;
    }

    public void setApplicationrequirements12(Boolean applicationrequirements12) {
        this.applicationrequirements12 = applicationrequirements12;
    }

    public void setApplicationrequirements13(Boolean applicationrequirements13) {
        this.applicationrequirements13 = applicationrequirements13;
    }

    public void setApplicationrequirements14(Boolean applicationrequirements14) {
        this.applicationrequirements14 = applicationrequirements14;
    }

    public void setApplicationrequirements15(Boolean applicationrequirements15) {
        this.applicationrequirements15 = applicationrequirements15;
    }
    ...
    public String toString() {
        return "LectureProfessorApplicationForm{" +
                ...
                ", name='" + name + '\'' +
                ", job='" + job + '\'' +
                ", serviceSchoolAndDepartment='" + serviceSchoolAndDepartment + '\'' +
                ...
                ", applicationrequirements10='" + applicationrequirements10 + '\'' +
                ", applicationrequirements11='" + applicationrequirements11 + '\'' +
                ", applicationrequirements12='" + applicationrequirements12 + '\'' +
                ", applicationrequirements13='" + applicationrequirements13 + '\'' +
                ", applicationrequirements14='" + applicationrequirements14 + '\'' +
                ", applicationrequirements15='" + applicationrequirements15 + '\'' +
                ", applicationrequirementsCheck='" + applicationrequirementsCheck + '\'' +
                ", lectureCategoryExp='" + lectureCategoryExp + '\'' +
                ", lectureCategoryInv='" + lectureCategoryInv + '\'' +
                ", lectureCategoryLif='" + lectureCategoryLif + '\'' +
