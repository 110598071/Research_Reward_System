...
<div class="content">
    <form>
        <table>
            ...
            <tr><td colspan="2" style="text-align: center; background-color: rgb(255, 255, 240)"><span><input type="button" width="10%" value="上一頁" name="close" onclick="javascript:location.href='ExcellentResearcherCatalog'"></span><span><button type="button" onclick="commit()">暫存</button></span></td></tr>
            </tbody>
        </table>
    </form>
</div>
