...
<div name="technologyTransfer" class="content">
    <form id="form">
        ...
        <table>
            <tbody>
            <tr>
                <td>一、 依「國立臺北科技大學論文點數計算公式」(如附表一)填寫。</td>
            </tr>
            <tr>
                <td>二、 每篇論文僅能單一作者提出申請，若有2位或以上本校教師為共同作者，請檢附其他教師同意書。</td>
            </tr>
            <tr>
                <td>三、 學術論著採計Scopus / WOS論文者，請檢附表B「傑出論文績效說明表」。並請檢附證明文件「期刊發表之論文首頁或以Scopus / WOS資料庫或scival分析系統之佐證」及「各篇期刊排名(以發表當年度為主) CiteScore / Journal Ranking、國際學者、企業、FWCI)」。</td>
            </tr>
            <tr>
