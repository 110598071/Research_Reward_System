...
<div class="container" style="margin: 0px auto;width: 90%;">
    <form method="post" action="Plan?func=international_formC001" enctype="multipart/form-data" id="c001_form">
        <table border="1" cellpadding="6" cellspacing="1" width="100%" align="center" style="border-spacing:0px;" class="inputForm">
            ...
            <tr>
                <td colspan="8" style="text-align: left;" class="four_sections">
                    <p>申請說明事項：</p>
                    <p style="padding-left: 2rem;">1.請檢附期刊發表之論文首頁及各篇期刊排名。學術論著正式出版年度以紙本刊登年度為準，若無紙本出版則以電子期刊出版年為基準。</p>
                    <p style="padding-left: 2rem;">2.請檢附Scopus資料庫或SciVal分析系統之佐證(含期刊排名CiteScore、國際學者、企業、FWCI)。</p>
                    <p style="padding-left: 2rem;">3.若某篇論文為SSCI且有企業及國際合著者，權重至多1.8倍計。</p>
                    <p style="padding-left: 2rem;">4.每篇論文僅能單一作者提出申請，若有2位或以上本校教師為共同作者，請檢附其他教師同意書。</p>
                </td>
            ...
            <tr>
                <td colspan="8" style="text-align: left;font-weight: bold;">
                    <p>
                        <input type="checkbox" name="representationClause" checked disabled="disabled"/>
...
<script>
    ...
    function calculateTotal() {
        ...
        $('input[id="commit_date"]').val(latest_data["commit_date"]);
